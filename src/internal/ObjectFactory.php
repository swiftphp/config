<?php
namespace swiftphp\config\internal;

use swiftphp\config\IObjectFactory;
...
class ObjectFactory implements IObjectFactory,IConfigurable
{
    ...
    public function create($objectId)
    {
        ...
        //注入全局属性(全局属性只有值类型)
        foreach ($this->m_config->getConfigValues(BuiltInConst::GLOBAL_CONFIG_SESSION) as $name=>$value){
